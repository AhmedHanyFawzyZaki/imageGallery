...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('categorized-image-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<?php $this->pageTitlecrumbs = 'Manage Categorized Images';?>
...
<?php $this->widget('ext.yiisortablemodel.widgets.SortableCGridView',array(
	...
	'columns'=>array(
		'image'=>array(
			'name'=>'image',
			'type'=>'raw',
			'value'=>'CHtml::image(Yii::app()->request->baseUrl."/media/".$data->image,"No image",array("width"=>100))',
                        'filter'=>''
		),
		'cat_id'=>array(
                    'name'=>'cat_id',
